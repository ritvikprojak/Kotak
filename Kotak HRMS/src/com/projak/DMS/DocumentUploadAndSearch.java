 ...
 * <p>
 */
public class DocumentUploadAndSearch extends Plugin {
	 ...
	 */
	public String getId() {
		return "DocumentUploadAndSearch";
	}
	...
	public String getScript() {
		return "DocumentUploadAndSearch.js";
	}
	...
	public String getDojoModule() {
		return "documentUploadAndSearchDojo";
	}
	...
	public String getCSSFileName() {
		return "DocumentUploadAndSearch.css";
	}
	...
	public PluginRequestFilter[] getRequestFilters() {
			return new PluginRequestFilter[] {
					 new DocumentUploadRestrictionRequestFilter()
			};
		}
	...
	public PluginResponseFilter[] getResponseFilters() {
		return new PluginResponseFilter[] {
	            new ViewOneBootstrapResponseFilter()
	        };
	}
	...
	public String getConfigurationDijitClass() {
		return "documentUploadAndSearchDojo.ConfigurationPane";
	}
	...
	public PluginFeature[] getFeatures() {
		return new com.ibm.ecm.extension.PluginFeature[] {new DocumentUploadAndSearchFeature()};
	}
