 ...
 * <p>
 */
public class FolderStructurePlugin extends Plugin {
	...
	public String getName(Locale locale) {
		return "Plugin to manage Folder structure in Browse Pane";
	}
	...
	public String getScript() {
		return "FolderStructurePlugin.js";
	}
	...
	public String getDojoModule() {
		return "folderStructurePluginDojo";
	}
	...
	public String getCSSFileName() {
		return "FolderStructurePlugin.css";
	}
	...
	public PluginAction[] getActions() {
		...
		return new com.ibm.ecm.extension.PluginAction[]{new com.projak.lichfl.CustomCheckIn(),new com.projak.lichfl.CustomEditPageAction()};
	}
	...
	public String getConfigurationDijitClass() {
		return "folderStructurePluginDojo.ConfigurationPane";
	}
	...
	public com.ibm.ecm.extension.PluginResponseFilter[] getResponseFilters() {
		return new com.ibm.ecm.extension.PluginResponseFilter[]{new com.projak.lichfl.FolderResponseService(),
				};
	}
	...
	public com.ibm.ecm.extension.PluginService[] getServices() {
		return new com.ibm.ecm.extension.PluginService[]{new com.projak.lichfl.UserAccess(),
			   new com.projak.lichfl.LocationDetails(), new com.projak.lichfl.CustomDocumentMenuService()};
	}
