 ...
 */
public class CustomDocumentMenuService extends PluginService {
	 ...
	 */
	public String getId() {
		return "CustomDocumentMenuService";
	}
	...
	public void execute(PluginServiceCallbacks callbacks,
			...
			throws Exception {
		//get the admin and user's document context menu from config file
		
		System.out.println("CustomDocumentMenuService.execute()");
		
		//String user = request.getRemoteUser();
		
		String adminUsers = NHLPropertyReader.getResourceBundle().getString("nhl.adminUsers");
		
		String adminMenu = NHLPropertyReader.getResourceBundle().getString("nhl.adminMenu");
		
		String userMenu = NHLPropertyReader.getResourceBundle().getString("nhl.userMenu");
		...
		responseJ.put("adminMenu", adminMenu);
		
		responseJ.put("userMenu", userMenu);
		
		responseJ.put("adminUsers", adminUsers);
