require([ "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/aspect",
		...
		aspect, desktop, contentitem, Request, on, contentlist,MessageDialog, AddContentItemDialog,BrowsePane,Deferred) {
	...
	var contentDeffred=new Deferred();
				...
				"UserAccess", {
					...
					requestCompleteCallback : function(response) {
						...
						if (response) {
							...
							contentDeffred.resolve(userDetails);
							return contentDeffred.promise;
						}
...
contentDeffred.then(function(userDetails){
