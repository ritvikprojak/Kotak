...
var isreload = ecm.model.desktop.isReloading();
console.log("Desktop.onLogin.entry() :"+isreload );
		...
		return function around() {
			...
			if (arguments[0] == 'openFolder' || arguments[0] == 'continueQuery') {
				...
				if (globalVariable) {
					...
					arguments[2].userDetails = JSON.stringify(globalVariable);
	...
	function openEntryTemplate(entryTemplate){
		...
		aspect.after(addContentItemDialog.addContentItemPropertiesPane, "onCompleteRendering", function() {
            ...
            // addContentItemDialog.addContentItemPropertiesPane.setPropertyValue( "DocumentSubType" , documentSubType);
             ...
             //added by Vara
			if(department === 'Credit Appraisal'){
	
				if(documentType === 'Loan Proposal'){
					addContentItemDialog.addContentItemPropertiesPane._commonProperties.setPropertyPropertyValue("RereferenceNumber","required",false);
				
				//addContentItemDialog.addContentItemPropertiesPane._commonProperties.setPropertyPropertyValue("Date","required",true);
				
				//addContentItemDialog.addContentItemPropertiesPane.setPropertyValue( "ApplNumber" , "");
				//addContentItemDialog.addContentItemPropertiesPane._commonProperties.setPropertyPropertyValue("ApplNumber","required",true);
				//addContentItemDialog.addContentItemPropertiesPane.setPropertyValue( "ApplNumber" , "");
				
			 }else if(documentType === 'Notes and Decision' || documentType === 'Correspondence'){
				
				addContentItemDialog.addContentItemPropertiesPane._commonProperties.setPropertyPropertyValue("ApplNumber","required",false);
				//addContentItemDialog.addContentItemPropertiesPane._commonProperties.setPropertyPropertyValue("RereferenceNumber","required",true);
