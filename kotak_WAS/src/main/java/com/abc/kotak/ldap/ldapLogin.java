...
public class ldapLogin 
{
	 private static final String CONTEXT_FACTORY_CLASS = "com.sun.jndi.ldap.LdapCtxFactory";
	    ...
	    public ldapLogin(String domainName) {
	...
	public static void main(String[] args) {
		...
		ldapLogin authentication = new ldapLogin("pf203860.Bokkawala.Central.Provinces.BANKOFCEYLON.LOCAL");
	    try {
	        boolean authResult = authentication.authenticate("pf203860", "pf203860");
