...
import com.abc.kotak.web.rest.util.HeaderUtil;
import com.abc.kotak.web.rest.util.PaginationUtil;
import com.abc.kotak.web.rest.errors.BadRequestAlertException;
...
public class UserResource {
    ...
    *//**
    ...
    @Timed
    public ResponseEntity<List<UserDTO>> getAllApprovers() {
        final List<UserDTO> list = userService.getAllApprovers();
